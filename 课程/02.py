list_data = [["张晓", "男", 26, "本科", "985"], ["刘蓓", "女", 31, "硕士", "双非"], ["李慧", "女", 24, "本科", "211"],
             ["彭松浩", "男", 20, "本科", "双非"],
             ["陈理顺", "男", 20, "本科", "双非"], ["林天庄", "男", 20, "大专", "双非"],
             ["李惊鸿", "男", 20, "本科", "双非"], ["李凤强", "男", 80, "硕士", "211"],
    ...
    if data[3] == tuple_data[0][0] or data[3] == tuple_data[0][1] or data[3] == tuple_data[0][2]:
        if data[2] <= tuple_data[1][0]:
            if data[4] == tuple_data[2][0] or data[4] == tuple_data[2][1]:
                ...
                list_candidate.append(data)
        else:
            list_resume.append(data)
